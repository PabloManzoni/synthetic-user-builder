...
export const GENERIC_DECISION_BEHAVIORS = [
  ...
  "Trusts system status labels",
  "Distrusts automated alerts",
...
export const GENERIC_FORBIDDEN_ASSUMPTIONS = [
  ...
  "Cannot assume a status is current unless timestamp is clear",
...
export const GENERIC_ABANDONMENT_RULES = [
  ...
  "Escalates externally when status cannot be confirmed",
